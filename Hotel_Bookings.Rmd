...
## Looking bookings, ADR, special requests for all months in 2015-2017 - Cancelled and non cancelled:
...
For both hotel, we do see a sort of trend where the the months that have most cancellations also have high average daily rate. 
