...
```{text}
Majority of the guest that end up staying are not repeat guests for both hotel types. This same number translated to the majority in cancellations for both hotels.
```
